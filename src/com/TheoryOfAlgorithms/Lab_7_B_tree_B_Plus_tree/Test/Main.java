package com.TheoryOfAlgorithms.Lab_7_B_tree_B_Plus_tree.Test;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BTree t = new BTree(4); // A B-Tree with minium degree 2
        t.insert(1);
        t.insert(3);
        t.insert(7);
        t.insert(10);
        ...
        t.remove(4.txt);
        System.out.println("Traversal of tree after removing 4.txt");
        t.traverse();
        System.out.println();
