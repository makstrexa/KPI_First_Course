package com.TheoryOfAlgorithms.Lab_6_Binary_Tree.Test;
...
public class BinarySearchTreeDemo {
    public static void main(String[] args) {
        ...
        BinarySearchTree anyTree = new BinarySearchTree();
        anyTree.DSW();
        long start7 = System.nanoTime();
        for (int i = 0; i < 5_000; i++) {
            anyTree.insert(arr.get(i));
        }
        long finish7 = System.nanoTime() - start7;
        System.out.println("\u001B[35mAdding 5_000 rand elems(balance tree): " + finish7 + " ns.");
        ...
        long finish9 = System.nanoTime() - start9;
        System.out.println("\u001B[35mAdding 5_000 serial nums(balance tree): " + finish9 + " ns.");
    }
