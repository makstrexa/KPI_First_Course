...
public class Client {
    public static void main(String[] args) {
        ...
        //FASTANDFURIOUS
        Character dominicToretto = new Character("Dominic Toretto");
        ...
        //EXTRA CHARACTERS
        Character noName1 = new Character("No Name 1");
        Character noName2 = new Character("No name 2");
    ...
    public static void characterWhichPlayWith(Character character) {
        ...
        for (Iterator i = character.getCinemasWithCharacters().iterator(); i.hasNext(); ) {
    ...
    public static void maxCountOfCharacters(CinemaDataBase cinemaDataBase) {
        ...
        for (Cinema cinemas : cinemaDataBase.getAllCinemas()) {
            ...
            if (cinemas.getCharactersFromCinema().size() > length) {
                ...
                System.out.println(cinema0.getCinemaTitle());
                break;
            }
        }
    }
